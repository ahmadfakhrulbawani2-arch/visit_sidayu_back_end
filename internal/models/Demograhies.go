...
type Demographies struct {
	...
	// BirthDeathYearData     int    `json:"birth_death_year_data"` // in which year the data is audited
	...
	// RoleGroupYearData      int    `json:"role_group_year_data"` // in which year the data is audited
